...
<?php
  ...
  <DIV class="featured clearfix">
    ...
    <div class="col-sm-7">
        <p class="assembly"> サンダー電子は台湾北部の宜蘭県にPCBアッセンブリ工場を有しております。 ディスプレイモジュールの製造実績と開発経験から得た品質管理を活かし、 お客様に高品質なPCB Assemblyサービスを提供いたします。 宜蘭工場は複数の生産ラインをコントロールしているので、 お客様の必要な数量に関わらず、柔軟に対応させて頂きます。 </p>
    </div>
    </div>
  </DIV>
<?php
