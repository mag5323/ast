<?php
    ...
    if (!empty($_POST['context'])) {
        ...
        try {
            $sql = "UPDATE info SET context = ? WHERE field_name = 'led_light'";
            $rs = $db->prepare($sql);
            ...
            <script>
                $(function() {
                    ...
                    $('.submit').click(function(e) {
                        ...
                        $.post('/dashboard/led_light.php', {context: editorObj.getData()}).
                            done(function (data) {
                                if (data.status === 200) {
                                    window.location = '/dashboard/led_light.php';
                                } else {
