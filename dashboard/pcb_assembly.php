<?php
    ...
    if (!empty($_POST['context'])) {
        ...
        try {
            $sql = "UPDATE info SET context = ? WHERE field_name = 'pcb_assembly'";
            $rs = $db->prepare($sql);
            ...
            <script>
                $(function() {
                    ...
                    $('.submit').click(function(e) {
                        ...
                        $.post('/dashboard/pcb_assembly.php', {context: editorObj.getData()}).
                            done(function (data) {
                                if (data.status === 200) {
                                    window.location = '/dashboard/pcb_assembly.php';
                                } else {
