<?php
    ...
    if (!empty($_POST['context'])) {
        ...
        try {
            $sql = "UPDATE info SET context = ? WHERE field_name = 'oem_service'";
            $rs = $db->prepare($sql);
...
<?php include 'include/nav.php'; ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <textarea id="editor" name="ediotr" data-id="<?php echo $raw['id']; ?>"><?php echo $raw['context']; ?></textarea>
                    </div><!-- end .col-md-12-->
                </div><!-- end .row -->
                <div class="row">
                    <div class="col-md-12">
            ...
            <script>
                $(function() {
                    ...
                    $('.submit').click(function(e) {
                        ...
                        $.post('/dashboard/oem_service.php', {context: editorObj.getData()}).
                            done(function (data) {
                                if (data.status === 200) {
                                    window.location = '/dashboard/oem_service.php';
                                } else {
