  ...
  <DIV class="featured clearfix">
    ...
    <div class="col-sm-4 col-sm-offset-4">
        <div class="list-group">
            <a href="files/LED-light/PAR38X2.pdf" target="_blank" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"></span>&nbsp PAR38X2</a>
            <a href="files/LED-light/PAR52U.pdf" target="_blank" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"></span>&nbsp PAR52U-B2</a>
        </div>
    </div>
  </DIV>
<?php
